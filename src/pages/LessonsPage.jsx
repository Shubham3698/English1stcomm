...
import { 
  ...
  BookOpen,
  MessageSquare,
  Layers // 🔥 Naya icon units ke liye
} from 'lucide-react';
...
export default function LessonsPage() {
  ...
  // 🔥 CALCULATION: Total Units aur Lectures nikalna based on active tab
      ...
      <div className="w-full max-w-md bg-[#F2EFE7] relative px-4">
        ...
        {!activeVideoLesson && !activeQuizLesson && (
          <div className="animate-fade-in pt-8 pb-10">
            ...
            {/* 🔥 UPDATED: Page Header with Units & Lectures Count */}
            ...
            {/* TAB SWITCHER (2 Books) - Sleek White Card */}
